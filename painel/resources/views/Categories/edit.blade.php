...
<div class="page-header">
    <h3 class="page-title"> Editar categoria - <?= $viewModel->objectReturn->title; ?> </h3>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('')}}/">Dashboard</a></li>
        <li class="breadcrumb-item" href="{{url('../')}}/Categories" aria-current="page">Categoria</li>
  ...
  <div class="row">
    <div class="col-md-12 col-xs-12">
      <form action="{{url('Categories/edit')}}/{{$viewModel->objectReturn->id}}" name="frm" 
